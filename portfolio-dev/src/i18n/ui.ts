...
export const ui = {
  en: {
    ...
    'experience.nfq.title': 'SCIB Integration - Financial Crime Project - Banco Santander',
    'experience.nfq.date': 'October 2024 - Present',
    'experience.nfq.text': `- Actualización y mantenimiento de servicios.
    - Documentación técnica de procesos.
    - Extracción de evidencias sobre cambios e implementaciones en el software.
    - Desarrollo de herramientas de automatización de tareas.
    - Gestión de colecciones y testing de APIs en Postman.
    - Gestión de Bases de Datos.
    - Implementación de protocolos de seguridad.
    - Expedición, firma, verificación y gestión de certificados digitales.`,
  ...
  es: {
    ...
    'experience.nfq.title': 'SCIB Integration - Proyecto Financial Crime - Banco Santander',
    'experience.nfq.date': 'Octubre de 2024 - Actualmente',
    'experience.nfq.text': `- Actualización y mantenimiento de servicios.
    - Documentación técnica de procesos.
    - Extracción de evidencias sobre cambios e implementaciones en el software.
    - Desarrollo de herramientas de automatización de tareas.
