...
export const ui = {
  en: {
    ...
    'experience.nter.title': 'Financial Crime & Fraud Prevention Consultant - Banco Santander',
    'experience.nter.date': 'October 2024 - Present',
    'experience.nter.text': `- Workflows planification and management using Control-M, starting from public and private lists loading to generation of suspected fraud alerts.
    - Monitorization of fraud detection system with Oracle’s suite: FCCM, EDQ, IPE, OBIEE, Weblogic, Oracle SQL Developer, etc., ensuring availability, data integrity and proper functioning of the alert generation system .
    - Formating and validation of clients and payments files according to SEPA (ISO20022), SWIFT MT/MX and FEDWIRE standards, ensuring their proper processing.
    - Development of tools and automations using Python and Bash, resulting in productivity increase on repetitive tasks.
    - Management and testing of Postman's microservices APIs collections, ensuring successful integration and proper functioning of services.
    - Preparation of technical documentation and evidence extraction of changes and implementations, contributing to internal regulatory compliance and enabling trazability of deployments.
    - Security protocols implementation, including creation, signing, and verification of digital certificates in order to estabilsh secure connections between services, ensuring regulatory compliance and integrity in comunications.`,
    ...
    - Efficient data management among applications.
    ...
    'projects.axpe-employees-api.text': 'Final exercise from a training period on apification. Rest API service for controlling employees of a company. It includes its OpenAPI 3.0 specification and implementation in Spring Boot.',
  ...
  es: {
    ...
    'experience.nter.title': 'Consultor en Financial Crime & Fraud Prevention - Banco Santander',
    'experience.nter.date': 'Octubre 2024 - Actualmente',
    'experience.nter.text': `- Planificación y gestión de workflows con Control-M, desde la carga de listas públicas y privadas hasta la generación de alertas sospechosas de fraude.
    - Monitorización del sistema de detección de fraude mediante la suite de Oracle: FCCM, EDQ, IPE, OBIEE, Weblogic, Oracle SQL Developer, etc., asegurando la disponibilidad, integridad de datos y el correcto funcionamiento de las alertas.
    - Formateo y validación de ficheros de clientes y pagos conforme a estándares SEPA (ISO20022), SWIFT MT/MX y FEDWIRE, asegurando su correcto procesamiento en el sistema.
    - Desarrollo de herramientas y automatizaciones con Python y Bash, resultando en un aumento de la productividad en tareas repetitivas.
    - Gestión y testing de colecciones de APIs de microservicios en Postman, asegurando la correcta integración y funcionamiento de los servicios.
    - Elaboración de documentación técnica y extracción de evidencias de cambios e implementaciones, contribuyendo al cumplimiento de la normativa interna y facilitando la trazabilidad de los despliegues.
    - Implementación de protocolos de seguridad, incluyendo la expedición, firma y verificación de certificados digitales para establecer conexiones seguras entre servicios, asegurando el cumplimiento normativo y la integridad de las comunicaciones.`,
    ...
    'experience.telefonica.text': `- Integración de proyectos entre Telefónica Kernel Global y la OB de Brasil y equipos de Vivo.
    - Implicación en los procesos de análisis y diseño de las APIs de 4P.​
    - Aportación de mejoras significativas en las diferentes fases del ciclo de vida de las APIs.​
    - Desarrollo y despliegue de numerosas herramientas de integración usando NodeJS, ReactJS y Express.
    - Documentación formal de todos los procesos llevados a cabo, además de generación de casos de prueba.`,

    'experience.pixel.title': 'Desarrollador Móvil en Pixel Innova',
    'experience.pixel.date': 'Febrero de 2022 - Mayo de 2022',
    'experience.pixel.text': `- Desarrollo de aplicaciones en Android e iOS.
    - Enfoque en la implementación de funciones clave, como la lectura e interpretación de códigos QR.
    - Gestión eficiente de datos entre las aplicaciones.
    ...
    'projects.axpe-employees-api.title': 'API de Empleados de Axpe',
    'projects.axpe-employees-api.text': 'Ejercicio final de un período de formación en apiificación. Servicio de API REST para gestionar los empleados de una empresa. Incluye la especificación OpenAPI 3.0 y su implementación en Spring Boot.',

    'projects.moviefav.title': 'MovieFav. Aplicación de Listado de Películas',
    'projects.moviefav.text': 'Aplicación móvil desarrollada para una prueba técnica, utilizando las bibliotecas Retrofit y Room para leer datos de una API y gestionar una base de datos local que permite la persistencia de datos.',

    'projects.survy.title': 'Survy. Aplicación educativa de encuestas y preguntas online',
    'projects.survy.text': 'Proyecto de Fin de Grado en Ingeniería Informática. Aplicación móvil para gestionar encuestas y preguntas online en el ámbito educativo.', 
    
    'projects.weather-vue.title': 'Weather Vue. Aplicación Web del Tiempo',
    'projects.weather-vue.text': 'Aplicación web simple desarrollada en VueJS para verificar el tiempo actual en cualquier ciudad, alimentada por la API de openweathermap.',
